...
#define I2C_MASTER_SCL_IO    22          // GPIO21 als SCL
#define I2C_MASTER_SDA_IO    21          // GPIO22 als SDA
#define I2C_MASTER_NUM       I2C_NUM_0   // I2C-Port 0
#define I2C_MASTER_FREQ_HZ   100000      // I2C-Taktfrequenz 100 kHz
#define BMP390_SENSOR_ADDR   0x76       // I2C-Adresse des BMP390
...
void app_main()
{
    ...
    while (1) {
        ...
        i2c_cmd_link_delete(cmd);
        if (ret != ESP_OK) {
            printf("2. Could not read pressure from BMP390 sensor\n");
            vTaskDelay(1000 / portTICK_RATE_MS);
            continue;
        }
